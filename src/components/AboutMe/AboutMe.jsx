      ...
      <div className="aboutMe__container">
        <div className="aboutMe__info">
          ...
          <p className="aboutMe__info-about">
            ...
            упрощают жизнь людей. Ранее работала в B2B продажах в сфере автоматизации бизнеса. Закончила курс по веб-разработке. Люблю природу, прогулки на свежем воздухе, настольные игры и путешествия. За последний год посетила 7 стран.
          </p>
